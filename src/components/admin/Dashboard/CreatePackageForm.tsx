...
const CreatePackageForm =  ({open,setOpen, createPackageCategoryHandler}:any)=> {
        ...
        const formValidation = yup.object({
                ...
                category:yup.string().required("Please select package category")
        })
        ...
        const handleSumbit = (values:FormikValues)=>  {
               ...
               CreatePackage(values).then(
                ...
                err=> {
                        setLoading(false)
                        toast.error("Failed to create new package")
                        Logger("Error creating new package:",err)
                }
               )
        ...
        return <Modal open={open}>
               <div className="flex justify-center w-full z-[999999]">
                        <div className="bg-white w-[90%] px-5 minMd:px-10 py-5 rounded-[10px] minMd:w-[500px] h-[650px] overflow-y-auto">
                                ...
                                <h1 className="text-center font-bold text-[21px] leading-[25px]">Add new package</h1>
                                                              ...
                                                              >
                                                                {
                                                                        packageCategories?.length >0 ? packageCategories?.map((category:any)=>(
                                                                                <MenuItem className="capitalize"  value={category?._id}>{category?.name}</MenuItem>
                                                                        )):
                                                                ...
                                                                <Field name="available">
                                                                        {
                                                                         ({field, form:{touched,errors}, meta}:any)=>(
                                                                                ...
                                                                                <RadioGroup
                                                                                        ...
                                                                                        {...field}
                                                                                >
                                                                                        <FormControlLabel defaultChecked ={true} value={true} control={<Radio />} label="Available" />
